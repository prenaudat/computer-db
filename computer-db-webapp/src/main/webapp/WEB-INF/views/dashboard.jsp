...
<body>
			...
			<table class="table table-striped table-bordered">
				<thead>
					<tr>
						...
						<th><custom:sort column="NAME" orderBy="${orderBy}"
								target="computers"></custom:sort></th>

						<th><custom:sort column="INTRODUCED" orderBy="${orderBy}"
								target="computers"></custom:sort></th>
						<!-- Table header for Discontinued Date -->
						<th><custom:sort column="DISCONTINUED" orderBy="${orderBy}"
								target="computers"></custom:sort></th>
						<!-- Table header for Company -->
						<th><custom:sort column="COMPANY" orderBy="${orderBy}"
								target="computers"></custom:sort></th>
				</thead>
	...
	<custom:pagination target="${target}" query="${query}"
		...
		pageNumber="${pageNumber}" size="${size}"></custom:pagination>
